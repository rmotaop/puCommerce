...
export default function StoreForm() {
    ...
    const isEditing = params.storeId !== 'create';
    ...
    useEffect(() => {
        ...
        if(isEditing) {
            storeService.findById(Number(params.storeId))
                .then(response => {
    ...
    function handleSubmit(event: any) {
        ...
        if(isEditing) {
            requestBody.id = params.storeId;
        }
        const request = isEditing
        ? storeService.updateRequest(requestBody) : storeService.insertRequest(requestBody);
        request.then(() => {
                ...
                <div className="dsc-product-form-container">
                    <form className="dsc-card dsc-form" onSubmit={handleSubmit}>
                        ...
                        <div className="dsc-form-controls-container">
                            ...
                            <div>
                                <FormInput
                                    { ...formData.priceMercade }
                                    onTurnDirty={handleTurnDirty}
                                    onChange={handleInputChange}
                                    className="dsc-form-control"
                                />
                                <div className="dsc-form-error">{formData.priceMercade.message}</div>
                            </div>
                            <div>
                                <FormInput
                                    { ...formData.imgUrl }
